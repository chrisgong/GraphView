 ...
 * Format or by default the Android default date format to convert the x-values
 * (that has to be millis from 01-01-1970) into a formatted date string.
 * 
 * See the DateAsXAxis example in the GraphView-Demos project to see a working
 * example.
 * 
 * @author jjoe64
 */
public class DateAsXAxisLabelFormatter extends DefaultLabelFormatter {
	...
	/**
	 * create the formatter with the Android default date format to convert the
	 * x-values.
	 * 
	 * @param context
	...
	/**
	 * create the formatter with your own custom date format to convert the
	 * x-values.
	 * 
	 * @param context
	 *            the application context
