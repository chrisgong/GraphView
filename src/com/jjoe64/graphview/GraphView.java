...
public class GraphView extends View {
	...
	/**
	 * our series (this does not contain the series that can be displayed on the
	 * right side. The right side series is a special feature of the
	 * {@link SecondScale} feature.
	 */
	...
	/**
	 * initialize the internal objects. This method has to be called directly in
	 * the constructors.
	 */
	protected void init() {
	...
	/**
	 * important: do not do modifications on the list object that will be
	 * returned. Use {@link #removeSeries(com.jjoe64.graphview.series.Series)}
	 * and {@link #addSeries(com.jjoe64.graphview.series.Series)}
	 * 
	 * @return all series
	 */
	...
	/**
	 * call this to let the graph redraw and recalculate the viewport. This will
	 * be called when a new series was added or removed and when data was
	 * appended via
	 * {@link com.jjoe64.graphview.series.BaseSeries#appendData(com.jjoe64.graphview.series.DataPointInterface, boolean, int)}
	 * or
	 * {@link com.jjoe64.graphview.series.BaseSeries#resetData(com.jjoe64.graphview.series.DataPointInterface[])}
	 * .
	 * 
	...
	protected void onDraw(Canvas canvas) {
		if (isInEditMode()) {
			...
			canvas.drawText("GraphView: No Preview available",
	...
	/**
	 * Draws the Graphs title that will be shown above the viewport. Will be
	 * called by GraphView.
	 * 
	 * @param canvas
	 *            Canvas
	 ...
	 * 
	 * @return the actual size of the title. if there is no title, 0 will be
	 *         returned.
	 */
	...
	/**
	 * Called by Android system if the size of the view was changed. Will
	 * recalculate the viewport and labels.
	 * 
	 * @param w
	 * @param h
	 * @param oldw
	...
	/**
	 * @return the space on the left side of the view from the left border to
	 *         the beginning of the graph viewport.
	 */
	public int getGraphContentLeft() {
		int border = getGridLabelRenderer().getStyles().padding;
		return border + getGridLabelRenderer().getLabelVerticalWidth()
				+ getGridLabelRenderer().getVerticalAxisTitleWidth();
	}

	/**
	 * @return the space on the top of the view from the top border to the
	...
	public int getGraphContentHeight() {
		int border = getGridLabelRenderer().getStyles().padding;
		int graphheight = getHeight() - (2 * border)
				- getGridLabelRenderer().getLabelHorizontalHeight()
				- getTitleHeight();
	...
	public int getGraphContentWidth() {
		int border = getGridLabelRenderer().getStyles().padding;
		int graphwidth = getWidth() - (2 * border)
				- getGridLabelRenderer().getLabelVerticalWidth();
		if (mSecondScale != null) {
			graphwidth -= getGridLabelRenderer()
	...
	/**
	 * Remove a specific series of the graph. This will also re-render the
	 * graph, but without recalculating the viewport and label sizes. If you
	 * want this, you have to call {@link #onDataChanged(boolean, boolean)}
	 * manually.
	 * 
	 * @param series
	 */
