 ...
 * @author jjoe64
 */
public class LineGraphSeries<E extends DataPointInterface> extends
		BaseSeries<E> {
	/**
	...
	private final class Styles {
		/**
		 * the thickness of the line. This option will be ignored if you are
		 * using a custom paint via
		 * {@link #setCustomPaint(android.graphics.Paint)}
		 */
		private float thickness = 1f;

		/**
		 * flag whether the area under the line to the bottom of the viewport
		 * will be filled with a specific background color.
		 * 
		 * @see #backgroundColor
		 */
	...
	/**
	 * custom paint that can be used. this will ignore the thickness and color
	 * styles.
	 */
	 ...
	 *            canvas
	 * @param isSecondScale
	 *            flag if it is the second scale
	 */
	@Override
	...
	/**
	 * the thickness of the line. This option will be ignored if you are using a
	 * custom paint via {@link #setCustomPaint(android.graphics.Paint)}
	 * 
	...
	/**
	 * flag whether the area under the line to the bottom of the viewport will
	 * be filled with a specific background color.
	 * 
	 ...
	 *            whether the background will be drawn
	 ...
	 * 
	 * @param customPaint
	 *            the custom paint to be used for rendering the line
	 */
